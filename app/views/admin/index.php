...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
    <!-- Quests Stats -->
    <a href="<?php echo BASE_URL; ?>/admin/quests" class="bg-surface-container-lowest border-2 border-on-surface p-6 pixel-shadow hover:bg-primary-container transition-colors cursor-pointer">
        <div class="flex justify-between items-start mb-4">
            <span class="font-h3 font-black text-on-surface uppercase">QUESTS</span>
        ...
        <div class="flex flex-col gap-4 mt-6">
            ...
            <div>
                <div class="text-2xl font-black text-on-surface"><?php echo htmlspecialchars($stats['total_quests']); ?></div>
    ...
    <!-- Reviews Stats -->
    <a href="<?php echo BASE_URL; ?>/admin/submissions" class="bg-[#ffd54f] border-2 border-on-surface p-6 pixel-shadow hover:bg-primary-container transition-colors cursor-pointer">
        <div class="flex justify-between items-start mb-4">
            <span class="font-h3 font-black text-on-surface uppercase">REVIEWS</span>
            <span class="material-symbols-outlined text-on-surface text-3xl">pending_actions</span>
        </div>
        <div class="flex flex-col gap-4 mt-6">
            <div>
                <div class="text-4xl font-black text-error"><?php echo htmlspecialchars($stats['pending_submissions']); ?></div>
                <div class="text-xs font-mono uppercase text-on-surface font-bold">PENDING SUBMISSIONS</div>
            </div>
            <div>
                <div class="text-2xl font-black text-on-surface"><?php echo htmlspecialchars($stats['pending_redemptions']); ?></div>
    ...
    <!-- Students Stats -->
    <a href="<?php echo BASE_URL; ?>/admin/students" class="bg-surface-container-lowest border-2 border-on-surface p-6 pixel-shadow hover:bg-primary-container transition-colors cursor-pointer">
        <div class="flex justify-between items-start mb-4">
            <span class="font-h3 font-black text-on-surface uppercase">STUDENTS</span>
        ...
        <div class="flex flex-col gap-4 mt-6">
            ...
            <div>
                <div class="text-2xl font-black text-on-surface"><?php echo htmlspecialchars($stats['total_students']); ?></div>
                <div class="text-xs font-mono uppercase text-secondary font-bold">TOTAL</div>
            </div>
        </div>
    </a>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
    <!-- Audit Log Panel -->
    <div class="bg-surface-container-lowest border-2 border-on-surface pixel-shadow">
        <div class="bg-[#1e6d12] border-b-4 border-on-surface p-3">
            <h2 class="font-label-pixel text-white uppercase text-center">AUDIT_LOG</h2>
        </div>
        <div class="p-2 bg-surface">
            <div class="flex flex-col font-label-pixel text-on-surface">
    ...
    <div class="bg-surface-container-lowest border-2 border-on-surface pixel-shadow">
        <div class="bg-error border-b-4 border-on-surface p-3">
